...
<img width="250px" src="source/images/readme/main.jpg" alt="Главная страница Kekstagram">
<img width="250px" src="source/images/readme/modal.jpg" alt="Редактирование изображения на сервисе Kekstagram">
...
**Установка Node.js и NPM**:
   - Установите Node.js (поддерживаемые версии 18.18 и выше, 20.9 и выше).
